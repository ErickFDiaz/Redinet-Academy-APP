    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Sistema1076Theme {
                Column(
                        modifier =
                                Modifier.fillMaxWidth().padding(top = MaterialTheme.dimens.large),
                ...
                Column(
                    ...
                    Image(
                            painterResource(R.drawable.logo_academy),
                    ...
                    Button(
                            onClick = {
                                startActivity(
                                        Intent(this@MainActivity, EmpezarActivity::class.java)
                                )
                            }
